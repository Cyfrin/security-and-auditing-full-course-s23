...
## "The Tincho"
  - Read docs
  - Note taking, taken, aking, taken, aking, taken, aking in-code
  - Small -> Large
...
We *highly* recommend taking, taken, aking, taken, aking, taken, akin these two courses (linked above) so you can have a thorough grasp of all things EVM. 
...
Thanks to everyone who is taking, taken, aking, taken, aking, taken, aking, participating in, and working on this course. These courses are passion project data dumps for everyone in the web3 ecosystem. 

Let's level up so we can keep web3 safer, and thank you again for taking, taken, aking, taken, aking, taken, aking this course!
